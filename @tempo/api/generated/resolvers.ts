...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  ...
  ProductTranslationCollectionTranslationCategoryTranslationAttributeTranslationValueTranslationPageTranslationShippingMethodTranslationSaleTranslationVoucherTranslationMenuItemTranslation: ( AttributeTranslation ) | ( CategoryTranslation ) | ( CollectionTranslation ) | ( MenuItemTranslation ) | ( PageTranslation ) | ( Omit<ProductTranslation, 'product'> & { product: _RefType['Product'] } ) | ( SaleTranslation ) | ( ShippingMethodTranslation ) | ( ValueTranslation ) | ( VoucherTranslation );
  TaxSourceLine: ( CheckoutLine ) | ( OrderLine );
  TaxSourceObject: ( Omit<Checkout, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( Omit<Order, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } );
  TranslatableItem: ( AttributeTranslation ) | ( CategoryTranslation ) | ( CollectionTranslation ) | ( MenuItemTranslation ) | ( PageTranslation ) | ( Omit<ProductTranslation, 'product'> & { product: _RefType['Product'] } ) | ( SaleTranslation ) | ( ShippingMethodTranslation ) | ( ValueTranslation ) | ( VoucherTranslation );
};

/** Mapping of interface types */
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  AbstractOrder: ( Omit<Checkout, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( Omit<Order, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } );
  AddressBase: ( Address );
  AddressEvent: ( Omit<AddressCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AddressDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AddressUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  AppBase: ( Omit<AppDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppInstalled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  AttributeBase: ( Omit<AttributeCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AttributeDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AttributeUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  BaseMutationResult: ( Omit<AddressMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<AppInstallationMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<AppMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<AppTokenMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<AttributeMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<AuthPluginMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<BoolMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CategoryMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ChannelMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ChannelReorderWarehousesMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CheckoutCompleteMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CheckoutMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CheckoutOptionalMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CheckoutPaymentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CollectionChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<CollectionMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<DigitalContentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<EventDeliveryMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ExportFileMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ExternalNotificationTriggerMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<FileMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<GiftCardBulkMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<GiftCardMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<GiftCardSettingsMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<Giftcardmutationresult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<GroupMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<IdListMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<InvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<JwtMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ManifestMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<MediaItemMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<MenuItemMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<MenuMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ObjectWithMetadataMutationResult, 'errors' | 'result'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, result: _RefType['ObjectWithMetadata'] } ) | ( Omit<OrderBulkMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderFulfillmentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderInvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderLineMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderLinesMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<OrderSettingsMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<Ordermutationresult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PageBulkMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PageKlassMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PageMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PaymentCheckBalanceMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PaymentInitializeMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PaymentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<PluginMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ProductAttributeAssignmentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ProductBulkMutationResult, 'errors' | 'objects'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, objects: Array<_RefType['Product']> } ) | ( Omit<ProductKlassMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ProductMediaAssignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, product: _RefType['Product'] } ) | ( Omit<ProductMediaMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, product: _RefType['Product'] } ) | ( Omit<ProductMediaUnassignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, product: _RefType['Product'] } ) | ( Omit<ProductMutationResult, 'errors' | 'result'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, result: _RefType['Product'] } ) | ( Omit<ProductPreorderDeactivationMutationResult, 'errors' | 'productVariant'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, productVariant: _RefType['Product'] } ) | ( Omit<SaleMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ShippingMethodChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ShippingMethodMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ShippingPriceMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ShippingPriceRemoveProductFromExcludeMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ShippingZoneMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<SiteMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<SiteTranslationMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<StaffNotificationRecipientMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<TaxClassMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<TaxConfigurationMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<TaxCountryConfigurationMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<TaxSourceObjectMutationResult, 'errors' | 'result'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>>, result: _RefType['TaxSourceObject'] } ) | ( Omit<TokenVerificationMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<TransactionItemMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<UserBulkMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<UserCreationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<UserMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<ValueMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<VoucherMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<WarehouseMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<WarehouseShippingZoneAssignmentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<WarehouseShippingZoneUnassignmentMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } ) | ( Omit<WebhookMutationResult, 'errors'> & { errors?: Maybe<Array<_RefType['ErrorInterface']>> } );
  BasePricingInfo: ( ProductPricingInfo );
  BaseTranslation: ( AttributeTranslation ) | ( CategoryTranslation ) | ( CollectionTranslation ) | ( MenuItemTranslation ) | ( PageTranslation ) | ( Omit<ProductTranslation, 'product'> & { product: _RefType['Product'] } ) | ( SaleTranslation ) | ( ShippingMethodTranslation ) | ( SiteTranslation ) | ( ValueTranslation ) | ( VoucherTranslation );
  CategoryBase: ( Omit<CategoryCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CategoryDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CategoryUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  ChannelBase: ( Omit<ChannelCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  CheckoutBase: ( Omit<CheckoutCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutFilterShippingMethods, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentListGateways, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingListMethodsForCheckout, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  CollectionBase: ( Omit<CollectionCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  ...
  Event: ( Omit<AddressCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AddressDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AddressUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppInstalled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AppUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AttributeCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AttributeDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<AttributeUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CalculateTaxes, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CategoryCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CategoryDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CategoryUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ChannelUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutFilterShippingMethods, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CheckoutUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CollectionUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CreateOrderd, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CustomerCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CustomerMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CustomerUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentApproved, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentCanceled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GroupCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GroupDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GroupUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<InvoiceDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<InvoiceRequested, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<InvoiceSent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MediaCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MediaDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MediaUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuItemCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuItemDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuItemUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderCancelled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderConfirmed, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFilterShippingMethods, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFulfilled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFullyPaid, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageKlassCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageKlassDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageKlassUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentAuthorize, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentCaptureEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentConfirmEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentListGateways, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentProcessEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentRefundEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentVoidEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ProductBackInStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'], productVariant: _RefType['Product'] } ) | ( Omit<ProductCreated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductDeleted, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductMetadataUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductOutOfStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'], productVariant: _RefType['Product'] } ) | ( Omit<ProductUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<SaleCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleToggle, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingListMethodsForCheckout, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingPriceCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingPriceDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingPriceUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<Subscription, 'event' | 'issuingPrincipal'> & { event: _RefType['Event'], issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<TransactionAction, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<TransactionActionRequest, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<TransactionItemMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<TranslationCreated, 'issuingPrincipal' | 'translation'> & { issuingPrincipal: _RefType['AppUser'], translation: _RefType['ProductTranslationCollectionTranslationCategoryTranslationAttributeTranslationValueTranslationPageTranslationShippingMethodTranslationSaleTranslationVoucherTranslationMenuItemTranslation'] } ) | ( Omit<TranslationUpdated, 'issuingPrincipal' | 'translation'> & { issuingPrincipal: _RefType['AppUser'], translation: _RefType['ProductTranslationCollectionTranslationCategoryTranslationAttributeTranslationValueTranslationPageTranslationShippingMethodTranslationSaleTranslationVoucherTranslationMenuItemTranslation'] } ) | ( Omit<ValueCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ValueDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ValueUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<WarehouseCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<WarehouseDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<WarehouseMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<WarehouseUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  FulfillmentBase: ( Omit<FulfillmentApproved, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentCanceled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<FulfillmentMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  GiftCardBase: ( Omit<GiftCardCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardStatusChanged, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GiftCardUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  GoogleAddressBase: ( Address );
  GroupBase: ( Omit<GroupCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GroupDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<GroupUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  InvoiceBase: ( Omit<InvoiceDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<InvoiceRequested, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<InvoiceSent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  Job: ( AppInstallation ) | ( ExportFile ) | ( Invoice );
  MediaBase: ( Omit<MediaCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MediaDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MediaUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  MenuBase: ( Omit<MenuCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  MenuItemBase: ( Omit<MenuItemCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuItemDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<MenuItemUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  Node: ( Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( AccountEvent ) | ( Address ) | ( Allocation ) | ( App ) | ( AppExtension ) | ( AppInstallation ) | ( AppToken ) | ( AsyncWebhookEvent ) | ( Attribute ) | ( AttributeTranslation ) | ( Category ) | ( CategoryTranslation ) | ( Channel ) | ( Omit<Checkout, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( CheckoutLine ) | ( Collection ) | ( CollectionChannelListing ) | ( CollectionTranslation ) | ( Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( Omit<DigitalContent, 'productVariant'> & { productVariant: _RefType['Product'] } ) | ( DigitalContentUrl ) | ( EventDelivery ) | ( ExportEvent ) | ( ExportFile ) | ( Fulfillment ) | ( FulfillmentLine ) | ( Omit<GiftCard, 'product'> & { product: _RefType['Product'] } ) | ( GiftCardEvent ) | ( GiftCardTag ) | ( Group ) | ( Invoice ) | ( MediaItem ) | ( Menu ) | ( MenuItem ) | ( MenuItemTranslation ) | ( Omit<Order, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( OrderDiscount ) | ( OrderEvent ) | ( OrderLine ) | ( Page ) | ( PageKlass ) | ( PageTranslation ) | ( Payment ) | ( PointOfContact ) | ( ProductChannelListing ) | ( ProductImage ) | ( ProductKlass ) | ( ProductMediaItem ) | ( Omit<ProductTranslation, 'product'> & { product: _RefType['Product'] } ) | ( Sale ) | ( SaleChannelListing ) | ( SaleTranslation ) | ( ShippingMethod ) | ( ShippingMethodChannelListing ) | ( ShippingMethodPostalCodeRule ) | ( ShippingMethodTranslation ) | ( ShippingZone ) | ( Site ) | ( SiteTranslation ) | ( StaffNotificationRecipient ) | ( Omit<Stock, 'productVariant'> & { productVariant: _RefType['Product'] } ) | ( SyncWebhookEvent ) | ( TaxClass ) | ( TaxConfiguration ) | ( TaxConfigurationPerCountry ) | ( Transaction ) | ( TransactionEvent ) | ( TransactionItem ) | ( User ) | ( Value ) | ( ValueTranslation ) | ( Voucher ) | ( VoucherChannelListing ) | ( VoucherTranslation ) | ( Warehouse ) | ( Webhook );
  ObjectWithMetadata: ( Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( App ) | ( Attribute ) | ( Category ) | ( Omit<Checkout, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( CheckoutLine ) | ( Collection ) | ( Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( Omit<DigitalContent, 'productVariant'> & { productVariant: _RefType['Product'] } ) | ( Fulfillment ) | ( Omit<GiftCard, 'product'> & { product: _RefType['Product'] } ) | ( Invoice ) | ( MediaItem ) | ( Menu ) | ( MenuItem ) | ( Omit<Order, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( OrderLine ) | ( Page ) | ( PageKlass ) | ( Payment ) | ( ProductKlass ) | ( Sale ) | ( ShippingMethod ) | ( ShippingZone ) | ( TaxClass ) | ( TaxConfiguration ) | ( TransactionItem ) | ( User ) | ( Voucher ) | ( Warehouse );
  OrderBase: ( Omit<CreateOrderd, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<DraftOrderUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderCancelled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderConfirmed, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFilterShippingMethods, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFulfilled, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderFullyPaid, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<OrderUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  PageBase: ( Omit<PageCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  PageKlassBase: ( Omit<PageKlassCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageKlassDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PageKlassUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  PaymentBase: ( Omit<PaymentAuthorize, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentCaptureEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentConfirmEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentProcessEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentRefundEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<PaymentVoidEvent, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  Product: ( Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } );
  ProductBase: ( Omit<ProductBackInStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'], productVariant: _RefType['Product'] } ) | ( Omit<ProductCreated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductDeleted, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductMetadataUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } ) | ( Omit<ProductOutOfStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'], productVariant: _RefType['Product'] } ) | ( Omit<ProductUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: _RefType['AppUser'], product: _RefType['Product'] } );
  SaleBase: ( Omit<SaleCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleToggle, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<SaleUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  ShippingPriceBase: ( Omit<ShippingPriceCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingPriceDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingPriceUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  ShippingZoneBase: ( Omit<ShippingZoneCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ShippingZoneUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  TempoNode: ( Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( AccountEvent ) | ( Address ) | ( Allocation ) | ( App ) | ( AppExtension ) | ( AppInstallation ) | ( AsyncWebhookEvent ) | ( Attribute ) | ( AttributeTranslation ) | ( Category ) | ( CategoryTranslation ) | ( Channel ) | ( Omit<Checkout, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( CheckoutLine ) | ( Collection ) | ( CollectionChannelListing ) | ( CollectionTranslation ) | ( Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: _RefType['Product'], variant: _RefType['Product'], variants: Array<_RefType['Product']> } ) | ( Omit<DigitalContent, 'productVariant'> & { productVariant: _RefType['Product'] } ) | ( DigitalContentUrl ) | ( EventDelivery ) | ( ExportEvent ) | ( ExportFile ) | ( Fulfillment ) | ( FulfillmentLine ) | ( Omit<GiftCard, 'product'> & { product: _RefType['Product'] } ) | ( GiftCardEvent ) | ( GiftCardTag ) | ( Group ) | ( Invoice ) | ( MediaItem ) | ( Menu ) | ( MenuItem ) | ( MenuItemTranslation ) | ( Omit<Order, 'fulfillmentMethod'> & { fulfillmentMethod?: Maybe<_RefType['FulfillmentMethod']> } ) | ( OrderDiscount ) | ( OrderEvent ) | ( OrderLine ) | ( Page ) | ( PageKlass ) | ( PageTranslation ) | ( Payment ) | ( PointOfContact ) | ( ProductChannelListing ) | ( ProductImage ) | ( ProductKlass ) | ( ProductMediaItem ) | ( Omit<ProductTranslation, 'product'> & { product: _RefType['Product'] } ) | ( Sale ) | ( SaleChannelListing ) | ( SaleTranslation ) | ( ShippingMethod ) | ( ShippingMethodChannelListing ) | ( ShippingMethodPostalCodeRule ) | ( ShippingMethodTranslation ) | ( ShippingZone ) | ( Site ) | ( SiteTranslation ) | ( StaffNotificationRecipient ) | ( Omit<Stock, 'productVariant'> & { productVariant: _RefType['Product'] } ) | ( SyncWebhookEvent ) | ( TaxClass ) | ( TaxConfiguration ) | ( TaxConfigurationPerCountry ) | ( Transaction ) | ( TransactionEvent ) | ( TransactionItem ) | ( User ) | ( Value ) | ( ValueTranslation ) | ( Voucher ) | ( VoucherChannelListing ) | ( VoucherTranslation ) | ( Warehouse ) | ( Webhook );
  TranslationBase: ( Omit<TranslationCreated, 'issuingPrincipal' | 'translation'> & { issuingPrincipal: _RefType['AppUser'], translation: _RefType['ProductTranslationCollectionTranslationCategoryTranslationAttributeTranslationValueTranslationPageTranslationShippingMethodTranslationSaleTranslationVoucherTranslationMenuItemTranslation'] } ) | ( Omit<TranslationUpdated, 'issuingPrincipal' | 'translation'> & { issuingPrincipal: _RefType['AppUser'], translation: _RefType['ProductTranslationCollectionTranslationCategoryTranslationAttributeTranslationValueTranslationPageTranslationShippingMethodTranslationSaleTranslationVoucherTranslationMenuItemTranslation'] } );
  UserBase: ( Omit<CustomerCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CustomerMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<CustomerUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<StaffUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  ValueBase: ( Omit<ValueCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ValueDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<ValueUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
  VoucherBase: ( Omit<VoucherCreated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherDeleted, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } ) | ( Omit<VoucherUpdated, 'issuingPrincipal'> & { issuingPrincipal: _RefType['AppUser'] } );
...
export type ResolversTypes = {
  ...
  AbstractProduct: ResolverTypeWrapper<Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: ResolversTypes['Product'], variant: ResolversTypes['Product'], variants: Array<ResolversTypes['Product']> }>;
  ...
  AddressMutationResult: ResolverTypeWrapper<Omit<AddressMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  AppMutationResult: ResolverTypeWrapper<Omit<AppMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  AttributeMutationResult: ResolverTypeWrapper<Omit<AttributeMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  CategoryMutationResult: ResolverTypeWrapper<Omit<CategoryMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ChannelMutationResult: ResolverTypeWrapper<Omit<ChannelMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ChannelReorderWarehousesMutationResult: ResolverTypeWrapper<Omit<ChannelReorderWarehousesMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  CheckoutCompleteMutationResult: ResolverTypeWrapper<Omit<CheckoutCompleteMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  CheckoutMutationResult: ResolverTypeWrapper<Omit<CheckoutMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  CheckoutNodeConnection: ResolverTypeWrapper<CheckoutNodeConnection>;
  CheckoutNodeEdge: ResolverTypeWrapper<CheckoutNodeEdge>;
  CheckoutOptionalMutationResult: ResolverTypeWrapper<Omit<CheckoutOptionalMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  CheckoutOrdering: CheckoutOrdering;
  CheckoutOrderingInput: CheckoutOrderingInput;
  CheckoutPaymentMutationResult: ResolverTypeWrapper<Omit<CheckoutPaymentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  CollectionChannelListingMutationResult: ResolverTypeWrapper<Omit<CollectionChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  CollectionMutationResult: ResolverTypeWrapper<Omit<CollectionMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ConcreteProduct: ResolverTypeWrapper<Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: ResolversTypes['Product'], variant: ResolversTypes['Product'], variants: Array<ResolversTypes['Product']> }>;
  ...
  DigitalContent: ResolverTypeWrapper<Omit<DigitalContent, 'productVariant'> & { productVariant: ResolversTypes['Product'] }>;
  ...
  DigitalContentMutationResult: ResolverTypeWrapper<Omit<DigitalContentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ExportFileMutationResult: ResolverTypeWrapper<Omit<ExportFileMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  FileMutationResult: ResolverTypeWrapper<Omit<FileMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  FileType: FileType;
  ...
  GiftCard: ResolverTypeWrapper<Omit<GiftCard, 'product'> & { product: ResolversTypes['Product'] }>;
  ...
  GiftCardBulkMutationResult: ResolverTypeWrapper<Omit<GiftCardBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  GiftCardMutationResult: ResolverTypeWrapper<Omit<GiftCardMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  GroupMutationResult: ResolverTypeWrapper<Omit<GroupMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  InvoiceMutationResult: ResolverTypeWrapper<Omit<InvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  JWTMutationResult: ResolverTypeWrapper<Omit<JwtMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  MediaItemMutationResult: ResolverTypeWrapper<Omit<MediaItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  MenuItemMutationResult: ResolverTypeWrapper<Omit<MenuItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  MenuMutationResult: ResolverTypeWrapper<Omit<MenuMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  OrderBulkMutationResult: ResolverTypeWrapper<Omit<OrderBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  OrderFulfillmentMutationResult: ResolverTypeWrapper<Omit<OrderFulfillmentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  OrderFullyPaid: ResolverTypeWrapper<Omit<OrderFullyPaid, 'issuingPrincipal'> & { issuingPrincipal: ResolversTypes['AppUser'] }>;
  OrderInvoiceMutationResult: ResolverTypeWrapper<Omit<OrderInvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  OrderLine: ResolverTypeWrapper<OrderLine>;
  OrderLineCreationInput: OrderLineCreationInput;
  OrderLineInput: OrderLineInput;
  OrderLineMutationResult: ResolverTypeWrapper<Omit<OrderLineMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  OrderLinesMutationResult: ResolverTypeWrapper<Omit<OrderLinesMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  OrderMutationResult: ResolverTypeWrapper<Omit<OrderMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  PageBulkMutationResult: ResolverTypeWrapper<Omit<PageBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  PageKlassMutationResult: ResolverTypeWrapper<Omit<PageKlassMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  PageMutationResult: ResolverTypeWrapper<Omit<PageMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  PaymentMutationResult: ResolverTypeWrapper<Omit<PaymentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  PluginMutationResult: ResolverTypeWrapper<Omit<PluginMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ProductAttributeAssignmentMutationResult: ResolverTypeWrapper<Omit<ProductAttributeAssignmentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ProductBackInStock: ResolverTypeWrapper<Omit<ProductBackInStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'], productVariant: ResolversTypes['Product'] }>;
  ...
  ProductCreated: ResolverTypeWrapper<Omit<ProductCreated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'] }>;
  ProductCreationInput: ProductCreationInput;
  ProductDeleted: ResolverTypeWrapper<Omit<ProductDeleted, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'] }>;
  ...
  ProductKlassMutationResult: ResolverTypeWrapper<Omit<ProductKlassMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ProductMediaAssignmentMutationResult: ResolverTypeWrapper<Omit<ProductMediaAssignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>>, product: ResolversTypes['Product'] }>;
  ProductMediaCreationInput: ProductMediaCreationInput;
  ProductMediaItem: ResolverTypeWrapper<ProductMediaItem>;
  ProductMediaMutationResult: ResolverTypeWrapper<Omit<ProductMediaMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>>, product: ResolversTypes['Product'] }>;
  ProductMediaUnassignmentMutationResult: ResolverTypeWrapper<Omit<ProductMediaUnassignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>>, product: ResolversTypes['Product'] }>;
  ProductMediaUpdateInput: ProductMediaUpdateInput;
  ProductMetadataUpdated: ResolverTypeWrapper<Omit<ProductMetadataUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'] }>;
  ...
  ProductOutOfStock: ResolverTypeWrapper<Omit<ProductOutOfStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'], productVariant: ResolversTypes['Product'] }>;
  ...
  ProductTranslation: ResolverTypeWrapper<Omit<ProductTranslation, 'product'> & { product: ResolversTypes['Product'] }>;
  ...
  ProductUpdated: ResolverTypeWrapper<Omit<ProductUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversTypes['AppUser'], product: ResolversTypes['Product'] }>;
  ...
  SaleInput: SaleInput;
  SaleMutationResult: ResolverTypeWrapper<Omit<SaleMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ShippingMethodChannelListingMutationResult: ResolverTypeWrapper<Omit<ShippingMethodChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ShippingMethodMutationResult: ResolverTypeWrapper<Omit<ShippingMethodMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ShippingPriceMutationResult: ResolverTypeWrapper<Omit<ShippingPriceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ShippingPriceRemoveProductFromExcludeMutationResult: ResolverTypeWrapper<Omit<ShippingPriceRemoveProductFromExcludeMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ShippingZoneMutationResult: ResolverTypeWrapper<Omit<ShippingZoneMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  SiteMutationResult: ResolverTypeWrapper<Omit<SiteMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  SiteTranslation: ResolverTypeWrapper<SiteTranslation>;
  SiteTranslationInput: SiteTranslationInput;
  SiteTranslationMutationResult: ResolverTypeWrapper<Omit<SiteTranslationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  StaffNotificationRecipientMutationResult: ResolverTypeWrapper<Omit<StaffNotificationRecipientMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  StateCode: StateCode;
  Stock: ResolverTypeWrapper<Omit<Stock, 'productVariant'> & { productVariant: ResolversTypes['Product'] }>;
  ...
  TaxConfigurationMutationResult: ResolverTypeWrapper<Omit<TaxConfigurationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  TokenVerificationMutationResult: ResolverTypeWrapper<Omit<TokenVerificationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  TransactionItemMutationResult: ResolverTypeWrapper<Omit<TransactionItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  UserBulkMutationResult: ResolverTypeWrapper<Omit<UserBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  UserConnection: ResolverTypeWrapper<UserConnection>;
  UserCreationInput: UserCreationInput;
  UserCreationResult: ResolverTypeWrapper<Omit<UserCreationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  UserEdge: ResolverTypeWrapper<UserEdge>;
  UserMutationResult: ResolverTypeWrapper<Omit<UserMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  ValueMutationResult: ResolverTypeWrapper<Omit<ValueMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  VoucherMutationResult: ResolverTypeWrapper<Omit<VoucherMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  WarehouseMutationResult: ResolverTypeWrapper<Omit<WarehouseMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
  ...
  WebhookMutationResult: ResolverTypeWrapper<Omit<WebhookMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversTypes['ErrorInterface']>> }>;
...
export type ResolversParentTypes = {
  ...
  AbstractProduct: Omit<AbstractProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: ResolversParentTypes['Product'], variant: ResolversParentTypes['Product'], variants: Array<ResolversParentTypes['Product']> };
  ...
  AddressMutationResult: Omit<AddressMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  AddressUpdateInput: AddressUpdateInput;
  ...
  AppMutationResult: Omit<AppMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  AttributeFilter: AttributeFilter;
  AttributeInput: AttributeInput;
  AttributeMutationResult: Omit<AttributeMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  CategoryFilter: CategoryFilter;
  CategoryInput: CategoryInput;
  CategoryMutationResult: Omit<CategoryMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  ChannelMutationResult: Omit<ChannelMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ChannelReorderWarehousesMutationResult: Omit<ChannelReorderWarehousesMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  CheckoutCompleteMutationResult: Omit<CheckoutCompleteMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  CheckoutMutationResult: Omit<CheckoutMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  CheckoutNodeConnection: CheckoutNodeConnection;
  CheckoutNodeEdge: CheckoutNodeEdge;
  CheckoutOptionalMutationResult: Omit<CheckoutOptionalMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  CheckoutOrderingInput: CheckoutOrderingInput;
  CheckoutPaymentMutationResult: Omit<CheckoutPaymentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  CheckoutPointOfContactInput: CheckoutPointOfContactInput;
  ...
  CollectionChannelListingMutationResult: Omit<CollectionChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  CollectionChannelListingUpdateInput: CollectionChannelListingUpdateInput;
  ...
  CollectionMutationResult: Omit<CollectionMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  CollectionOrderingInput: CollectionOrderingInput;
  ...
  ConcreteProduct: Omit<ConcreteProduct, 'defaultVariant' | 'variant' | 'variants'> & { defaultVariant: ResolversParentTypes['Product'], variant: ResolversParentTypes['Product'], variants: Array<ResolversParentTypes['Product']> };
  ...
  DateTimeRangeInput: DateTimeRangeInput;
  DigitalContent: Omit<DigitalContent, 'productVariant'> & { productVariant: ResolversParentTypes['Product'] };
  DigitalContentConnection: DigitalContentConnection;
  DigitalContentEdge: DigitalContentEdge;
  DigitalContentInput: DigitalContentInput;
  DigitalContentMutationResult: Omit<DigitalContentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  DigitalContentUploadInput: DigitalContentUploadInput;
  ...
  ExportFileFilter: ExportFileFilter;
  ExportFileMutationResult: Omit<ExportFileMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ExportFileOrderingInput: ExportFileOrderingInput;
  ExportGiftCardsInput: ExportGiftCardsInput;
  ExportInfoInput: ExportInfoInput;
  ExportProductsInput: ExportProductsInput;
  ...
  File: File;
  FileMutationResult: Omit<FileMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  GiftCard: Omit<GiftCard, 'product'> & { product: ResolversParentTypes['Product'] };
  GiftCardAddNoteInput: GiftCardAddNoteInput;
  GiftCardBase: ResolversInterfaceTypes<ResolversParentTypes>['GiftCardBase'];
  GiftCardBulkCreationInput: GiftCardBulkCreationInput;
  GiftCardBulkMutationResult: Omit<GiftCardBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  GiftCardMutationResult: Omit<GiftCardMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  GroupFilter: GroupFilter;
  GroupMutationResult: Omit<GroupMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  GroupOrderingInput: GroupOrderingInput;
  GroupUpdateInput: GroupUpdateInput;
  ...
  InvoiceMutationResult: Omit<InvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  JWT: Jwt;
  JWTMutationResult: Omit<JwtMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  MediaItemMutationResult: Omit<MediaItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  MediaOrderingInput: MediaOrderingInput;
  ...
  MenuItemInput: MenuItemInput;
  MenuItemMoveInput: MenuItemMoveInput;
  MenuItemMutationResult: Omit<MenuItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  MenuItemOrderingInput: MenuItemOrderingInput;
  ...
  MenuMutationResult: Omit<MenuMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  MenuOrderingInput: MenuOrderingInput;
  ...
  OrderBulkMutationResult: Omit<OrderBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  OrderFulfillmentLineInput: OrderFulfillmentLineInput;
  OrderFulfillmentMutationResult: Omit<OrderFulfillmentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  OrderFullyPaid: Omit<OrderFullyPaid, 'issuingPrincipal'> & { issuingPrincipal: ResolversParentTypes['AppUser'] };
  OrderInvoiceMutationResult: Omit<OrderInvoiceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  OrderLine: OrderLine;
  OrderLineCreationInput: OrderLineCreationInput;
  OrderLineInput: OrderLineInput;
  OrderLineMutationResult: Omit<OrderLineMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  OrderLinesMutationResult: Omit<OrderLinesMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  OrderMetadataUpdated: Omit<OrderMetadataUpdated, 'issuingPrincipal'> & { issuingPrincipal: ResolversParentTypes['AppUser'] };
  OrderMutationResult: Omit<OrderMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  PageBulkMutationResult: Omit<PageBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  PageKlassFilter: PageKlassFilter;
  PageKlassMutationResult: Omit<PageKlassMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  PageKlassOrderingInput: PageKlassOrderingInput;
  PageKlassUpdateInput: PageKlassUpdateInput;
  PageKlassUpdated: Omit<PageKlassUpdated, 'issuingPrincipal'> & { issuingPrincipal: ResolversParentTypes['AppUser'] };
  PageMutationResult: Omit<PageMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  PageOrderingInput: PageOrderingInput;
  ...
  PaymentMutationResult: Omit<PaymentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  PluginFilter: PluginFilter;
  PluginMutationResult: Omit<PluginMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  PluginOrderingInput: PluginOrderingInput;
  PluginStatusInChannelsInput: PluginStatusInChannelsInput;
  PluginUpdateInput: PluginUpdateInput;
  ...
  ProductAttributeAssignmentMutationResult: Omit<ProductAttributeAssignmentMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ProductAttributeAssignmentUpdateInput: ProductAttributeAssignmentUpdateInput;
  ProductBackInStock: Omit<ProductBackInStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'], productVariant: ResolversParentTypes['Product'] };
  ...
  ProductCreated: Omit<ProductCreated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'] };
  ProductCreationInput: ProductCreationInput;
  ProductDeleted: Omit<ProductDeleted, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'] };
  ...
  ProductKlassFilter: ProductKlassFilter;
  ProductKlassInput: ProductKlassInput;
  ProductKlassMutationResult: Omit<ProductKlassMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ProductKlassNodeConnection: ProductKlassNodeConnection;
  ProductKlassNodeEdge: ProductKlassNodeEdge;
  ProductKlassOrderingInput: ProductKlassOrderingInput;
  ProductMediaAssignmentMutationResult: Omit<ProductMediaAssignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>>, product: ResolversParentTypes['Product'] };
  ProductMediaCreationInput: ProductMediaCreationInput;
  ProductMediaItem: ProductMediaItem;
  ProductMediaMutationResult: Omit<ProductMediaMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>>, product: ResolversParentTypes['Product'] };
  ProductMediaUnassignmentMutationResult: Omit<ProductMediaUnassignmentMutationResult, 'errors' | 'product'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>>, product: ResolversParentTypes['Product'] };
  ProductMediaUpdateInput: ProductMediaUpdateInput;
  ProductMetadataUpdated: Omit<ProductMetadataUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'] };
  ...
  ProductOrderingInput: ProductOrderingInput;
  ProductOutOfStock: Omit<ProductOutOfStock, 'issuingPrincipal' | 'product' | 'productVariant'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'], productVariant: ResolversParentTypes['Product'] };
  ...
  ProductStockFilter: ProductStockFilter;
  ProductTranslation: Omit<ProductTranslation, 'product'> & { product: ResolversParentTypes['Product'] };
  ...
  ProductUpdated: Omit<ProductUpdated, 'issuingPrincipal' | 'product'> & { issuingPrincipal: ResolversParentTypes['AppUser'], product: ResolversParentTypes['Product'] };
  ...
  SaleFilter: SaleFilter;
  SaleInput: SaleInput;
  SaleMutationResult: Omit<SaleMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  SaleOrderingInput: SaleOrderingInput;
  ...
  ShippingMethodChannelListingAddInput: ShippingMethodChannelListingAddInput;
  ShippingMethodChannelListingInput: ShippingMethodChannelListingInput;
  ShippingMethodChannelListingMutationResult: Omit<ShippingMethodChannelListingMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ShippingMethodMutationResult: Omit<ShippingMethodMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  ShippingPriceExcludeProductsInput: ShippingPriceExcludeProductsInput;
  ShippingPriceInput: ShippingPriceInput;
  ShippingPriceMutationResult: Omit<ShippingPriceMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ShippingPriceRemoveProductFromExcludeMutationResult: Omit<ShippingPriceRemoveProductFromExcludeMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ShippingPriceTranslationInput: ShippingPriceTranslationInput;
  ...
  ShippingZoneMutationResult: Omit<ShippingZoneMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ShippingZoneUpdateInput: ShippingZoneUpdateInput;
  ShippingZoneUpdated: Omit<ShippingZoneUpdated, 'issuingPrincipal'> & { issuingPrincipal: ResolversParentTypes['AppUser'] };
  ShopSettingsUpdateInput: ShopSettingsUpdateInput;
  Site: Site;
  SiteDomainInput: SiteDomainInput;
  SiteMutationResult: Omit<SiteMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  SiteTranslation: SiteTranslation;
  SiteTranslationInput: SiteTranslationInput;
  SiteTranslationMutationResult: Omit<SiteTranslationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  Size: Size;
  ...
  StaffNotificationRecipientInput: StaffNotificationRecipientInput;
  StaffNotificationRecipientMutationResult: Omit<StaffNotificationRecipientMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  StaffUpdateInput: StaffUpdateInput;
  StaffUpdated: Omit<StaffUpdated, 'issuingPrincipal'> & { issuingPrincipal: ResolversParentTypes['AppUser'] };
  StaffUserFilter: StaffUserFilter;
  Stock: Omit<Stock, 'productVariant'> & { productVariant: ResolversParentTypes['Product'] };
  ...
  TaxConfigurationFilter: TaxConfigurationFilter;
  TaxConfigurationMutationResult: Omit<TaxConfigurationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  TimePeriodInputType: TimePeriodInputType;
  TokenVerificationMutationResult: Omit<TokenVerificationMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ...
  TransactionItemMutationResult: Omit<TransactionItemMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  TransactionUpdateInput: TransactionUpdateInput;
  ...
  UserBulkMutationResult: Omit<UserBulkMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  UserConnection: UserConnection;
  UserCreationInput: UserCreationInput;
  UserCreationResult: Omit<UserCreationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  UserEdge: UserEdge;
  UserMutationResult: Omit<UserMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  UserOrderingInput: UserOrderingInput;
  ...
  ValueFilter: ValueFilter;
  ValueInput: ValueInput;
  ValueMutationResult: Omit<ValueMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  ValueSelectableTypeInput: ValueSelectableTypeInput;
  ...
  VoucherMutationResult: Omit<VoucherMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  VoucherOrderingInput: VoucherOrderingInput;
  ...
  WarehouseMutationResult: Omit<WarehouseMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  WarehouseOrderingInput: WarehouseOrderingInput;
  ...
  Webhook: Webhook;
  WebhookCreationInput: WebhookCreationInput;
  WebhookMutationResult: Omit<WebhookMutationResult, 'errors'> & { errors?: Maybe<Array<ResolversParentTypes['ErrorInterface']>> };
  WebhookUpdateInput: WebhookUpdateInput;
