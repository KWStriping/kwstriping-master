...
} from '@tempo/dashboard/oldSrc/utils/maps';
  ...
  return [
    {
      ...createNumberField(
        ...
        t('dashboard_nitialBalanceLabel', messages.initialBalanceLabel.defaultMessage),
...

    {
      ...createNumberField(
        ...
        t('dashboard_urrentBalanceLabel', messages.currentBalanceLabel.defaultMessage),
    ...
    },
    {
      ...createOptionsField(
        ...
        t('dashboard_urrencyLabel', messages.currencyLabel.defaultMessage),
        [opts.currency.value],
        false,
    ...
    },
    {
      ...createAutocompleteField(
        ...
        t('dashboard_agLabel', messages.tagLabel.defaultMessage),
        opts.tag.value,
    ...
    },
    {
      ...createAutocompleteField(
        ...
        t('dashboard_productLabel', messages.productLabel.defaultMessage),
        opts.product.value,
    ...
    },
    {
      ...createAutocompleteField(
        ...
        t('dashboard_sedByLabel', messages.usedByLabel.defaultMessage),
        opts.usedBy.value,
    ...
    },
    {
      ...createOptionsField(
        ...
        t('dashboard_statusLabel', messages.statusLabel.defaultMessage),
        [opts.status.value],
        false,
        [
          {
            label: t('dashboard_enabledOptionLabel', messages.enabledOptionLabel.defaultMessage),
            value: GiftCardStatusFilterEnum.enabled,
          },
          {
            label: t(
              'dashboard_disabledOptionLabel',
