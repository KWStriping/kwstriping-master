...
const orderBase: OrderDetailsFragment = {
  ...
  id: 'T3JkZXI6MTk=',
  number: '19',
  paymentStatus: ChargeStatus.FullyCharged,
    ...
    const unfulfilledLines: OrderLineFragment[] = [
      {
        ...
        thumbnail: {
          url: 'http://localhost:8000/media/__sized__/products/tempo-digital-03_2-thumbnail-255x255.png',
          __typename: 'Image',
        },
        __typename: 'OrderLine',
      },
      ...
      },
      {
        ...
        thumbnail: {
          url: 'http://localhost:8000/media/__sized__/products/tempodemoproduct_cl_boot06_1-thumbnail-255x255.png',
          __typename: 'Image',
        },
        __typename: 'OrderLine',
      },
