export const updateProductPageMessages = {
  ...
  deleteVariantDialogSubtitle: {
    id: 'ukdRUv',
    defaultMessage:
      '{count,plural,one{Are you sure you want to delete this variant?} other{Are you sure you want to delete {{displayQuantity}} variants?}}',
