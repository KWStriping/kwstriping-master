    ...
    <>
      <Typography className={styles.dialogLabel ?? ''}>
        <>
          ...
          {m.dashboard_wuu_X() ?? 'Information exported:'}
        </>
      </Typography>
      <div className={styles.scrollArea ?? ''}>
        ...
        <FieldAccordion
          className={styles.accordion ?? ''}
          title={
            m.dashboard__aYF_() ?? 'Product Organization'
        ...
        <Accordion
          className={styles.accordion ?? ''}
          title={m.dashboard_attributes() ?? 'Attributes'}
          quickPeek={
        ...
        >
          <TextField
            ...
            label={m.dashboard_icEbK() ?? 'Search Atrtibuttes'}
            placeholder={t(
              'dashboard_Ic2/h',
        ...
        <FieldAccordion
          className={styles.accordion ?? ''}
          title={
            m.dashboard_j_Cb_() ?? 'Financial Information'
        ...
        <Accordion
          className={styles.accordion ?? ''}
          title={
            m.dashboard_jpTLF() ?? 'Inventory Information'
        ...
        >
          ...
          <Typography>{m.dashboard_Rz_hM() ?? 'Export Product Stock Quantity to CSV'}</Typography>
          <div>
            <Option
            ...
            >
              <>
                ...
                {m.dashboard_Gm_E_() ?? 'Export stock for all warehouses'}
              </>
            </Option>
          </div>
          <Divider className={styles.hrWarehouses ?? ''} />
          <Typography className={styles.warehousesLabel ?? ''} variant="subtitle1">
            <>
              ...
              {m.dashboard_QMTKI() ?? 'Warehouses A to Z'}
            </>
          </Typography>
