...
import CatalogIcon from '@tempo/dashboard/assets/images/menu-catalog-icon.svg';
import ConfigurationIcon from '@tempo/dashboard/assets/images/menu-configure-icon.svg';
import CustomerIcon from '@tempo/dashboard/assets/images/menu-customers-icon.svg';
import DiscountsIcon from '@tempo/dashboard/assets/images/menu-discounts-icon.svg';
import HomeIcon from '@tempo/dashboard/assets/images/menu-home-icon.svg';
import OrdersIcon from '@tempo/dashboard/assets/images/menu-orders-icon.svg';
import PagesIcon from '@tempo/dashboard/assets/images/menu-pages-icon.svg';
import PhotoFilmIcon from '@tempo/dashboard/assets/images/menu-photo-film-icon.svg';
import TranslationIcon from '@tempo/dashboard/assets/images/menu-translation-icon.svg';
