        ...
        {!excludedFields.includes('firstName') && (
          <div className="col-span-full sm:col-span-6">
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  label={m.checkout_firstNameField() ?? 'First name'}
                  id="firstName"
                  fullWidth
                  spellCheck={false}
                  required
        ...
        {!excludedFields.includes('lastName') && (
          <div className="col-span-full sm:col-span-6">
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  label={m.checkout_lastNameField() ?? 'Last name'}
                  id="lastName"
                  fullWidth
                  spellCheck={false}
                  required
        ...
        {autocomplete && (
          <div className="col-span-full">
            <AddressAutocompleteInput
              ...
              label={m.checkout_addressField() ?? 'Address'}
              allowNames={true}
              bounds={
                // TODO: Fix this hack!
                areaLatLng && {
        ...
        >
          ...
          <div className="col-span-full sm:col-span-6">
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  label={m.checkout_cityField() ?? 'City'}
                  id="city"
                  fullWidth
                  spellCheck={false}
                  required
          ...
          <div className="col-span-full sm:col-span-4">
            <Controller
              ...
              render={({ field, fieldState }) => {
                ...
                return (
                  <TextField
                    label={m.checkout_countryArea() ?? 'Province'}
                    id="countryArea"
                    spellCheck={false}
                    required
                    {...field}
          ...
          <div className="col-span-full sm:col-span-6">
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  label={m.checkout_postalCodeField() ?? 'Postal code'}
                  id="postal-code"
          ...
          <div className="col-span-full">
            <Controller
              ...
              render={({ field }) => {
                return (
                  <TextField
                    label={m.checkout_phoneField() ?? 'Phone'}
                    id="phone"
                    fullWidth
