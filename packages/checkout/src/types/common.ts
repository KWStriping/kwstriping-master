import type { SettingType } from '@core/types/settings';
import type { CHECKOUT_SECTIONS } from '@core/checkout/constants';
import type { PaymentProviderID, PaymentMethodID } from '@core/checkout/types/payments';

export type CheckoutSectionKey = (typeof CHECKOUT_SECTIONS)[number];
