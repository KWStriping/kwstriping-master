import { CheckoutContactInfoUpdateDocument } from '@core/api';
...
export function ContactInfoSection({
  ...
  return (
    <CheckoutSection
      ...
      header={t('checkout.contactInfo.header', 'Contact info')}
      validate={validate}
      className={className}
    >
      {editing ? (
        <>
          ...
          {enablePointsOfContact && (
            <>
              ...
              <div>
                ...
                >
                  {t('checkout.contactInfo.addPointOfContact', 'Add point of contact')}
                </Button>
              </div>
            </>
          )}
          {INCLUDE_SAVE_BUTTON && enablePointsOfContact && (
            ...
            >
              {t('checkout.contactInfo.save', 'Save')}
            </Button>
          )}
        </>
      ) : (
