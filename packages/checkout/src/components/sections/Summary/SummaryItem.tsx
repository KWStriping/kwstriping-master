import type { CheckoutLineFragment, OrderLineFragment } from '@core/api';
      ...
      <div className="summary-row w-full items-start">
        <div className="flex flex-col">
          <Typography
            fontWeight="bold"
            aria-label={t(
              summaryLabels.summaryItemName.id,
              summaryLabels.summaryItemName.defaultMessage
            )}
            className="mb-3"
          >
            {productName}
          ...
          <Typography
            fontSize="xs"
            aria-label={t(summaryLabels.productName.id, summaryLabels.productName.defaultMessage)}
            className="max-w-38"
          >
            {attributesText}
          </Typography>
