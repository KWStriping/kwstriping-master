...
import NewPasswordPage from '@dashboard/components/auth/NewPasswordPage';
import type { NewPasswordPageFormData } from '@dashboard/components/auth/NewPasswordPage';
