...
import { GIFT_CARD_LIST_QUERY } from '@dashboard/oldSrc/giftCards/GiftCardsList/queries';
import useGiftCardDetails from '@dashboard/oldSrc/giftCards/GiftCardUpdate/providers/GiftCardDetailsProvider/hooks/useGiftCardDetails';
