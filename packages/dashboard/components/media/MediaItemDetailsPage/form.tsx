...
import { createMediaTypeSelectHandler } from '@dashboard/oldSrc/media/utils/handlers';
import { validateMediaCreateData } from '@dashboard/oldSrc/media/utils/validation';
...
const getInitialFormData = (itemExists: boolean, item?: MediaItemDetailsFragment): MediaFormData => ({
  type: null,
