...
import type { CollectionListQuery } from '@core/api/graphql';
import { canBeSorted } from '@dashboard/oldSrc/collections/sort';
import { CollectionListUrlOrdering, collectionUrl } from '@dashboard/oldSrc/collections/urls';
  ...
  return (
    <ResponsiveTable>
      ...
      >
        ...
        >
          {t('dashboard.ZsE96', 'Collection Name')}
        </TableCellHeader>
        <TableCellHeader
          direction={
        ...
        >
          {t('dashboard.WQt3s', 'No. of Products')}
        </TableCellHeader>
        ...
        >
          <>
            ...
            {t('dashboard.xdBmI', 'Availability')}
          </>
        </TooltipTableCellHeader>
      </TableHead>
      <TableFooter>
          ...
          () => (
            <TableRow>
              <TableCell colSpan={numberOfColumns}>
                {t('dashboard.w+9F7', 'No collections found')}
              </TableCell>
            </TableRow>
          )
        )}
