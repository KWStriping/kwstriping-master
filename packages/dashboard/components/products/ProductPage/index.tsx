...
import { VariantDetailsChannelsAvailabilityCard } from '@dashboard/components/products/ProductChannels/ChannelsAvailabilityCard';
...
import type { ChannelPriceData } from '@dashboard/oldSrc/channels/utils';
import { productUrl } from '@dashboard/oldSrc/products/urls';
import { getSelectedMedia } from '@dashboard/oldSrc/products/utils/data';
                ...
                <Grid variant="inverted">
                  ...
                  <div>
                    ...
                    {!!nonSelectionAttributes?.length && (
                      <>
                        <Attributes
                          title={t('dashboard.onSelectionAttributes', 'Variant Attributes')}
                    ...
                    {!!selectionAttributes?.length && (
                      <>
                        <Attributes
                          title={t(
                            'dashboard.selectionAttributesHeader',
