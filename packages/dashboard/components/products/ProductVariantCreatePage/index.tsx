...
import { ProductDetailsChannelsAvailabilityCard } from '@dashboard/components/products/ProductChannels/ChannelsAvailabilityCard';
          ...
          <Container>
            ...
            <Grid variant="inverted">
              ...
              <div>
                ...
                />
                <Attributes
                  title={t('dashboard.attributesHeader', 'Variant Attributes')}
                ...
                <CardSpacer />
                <Attributes
                  title={t('dashboard.attributesSelectionHeader', 'Variant Selection Attributes')}
                  attributes={data?.attributes?.filter(
                    (attribute) =>
                      attribute.data?.variantAttributeScope ===
            ...
            <SaveBar
              ...
              labels={{
                confirm: t('dashboard.saveVariant', 'Save variant'),
                delete: t('dashboard.deleteVariant', 'Delete Variant'),
              }}
