...
import { getVariantAttributeInputFromProduct } from '@dashboard/oldSrc/products/utils/data';
import {
  createPreorderEndDateChangeHandler,
  getChannelsInput,
} from '@dashboard/oldSrc/products/utils/handlers';
import { validateVariantData } from '@dashboard/oldSrc/products/utils/validation';
