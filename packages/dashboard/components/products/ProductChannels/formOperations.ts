import type { ProductCreateDataQuery } from '@core/api/graphql';
import type { UseFormsetOutput } from '@dashboard/hooks/useFormset';
import type { ChannelPriceAndPreorderData } from '@dashboard/oldSrc/channels/utils';
import { getChannelsInput } from '@dashboard/oldSrc/products/utils/handlers';
import { validateCostPrice, validatePrice } from '@dashboard/oldSrc/products/utils/validation';
