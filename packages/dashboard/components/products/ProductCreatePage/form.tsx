...
import type {
  AttributeInput,
  AttributeInputData,
} from '@dashboard/components/attributes/AttributesCard';
...
import type { ChannelData, ChannelPriceArgs } from '@dashboard/oldSrc/channels/utils';
import { PRODUCT_CREATE_FORM_ID } from '@dashboard/oldSrc/products/ProductCreate/consts';
import type { ProductKlass } from '@dashboard/oldSrc/products/utils/data';
import { getAttributeInputFromProductKlass } from '@dashboard/oldSrc/products/utils/data';
import {
