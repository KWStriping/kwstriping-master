            ...
            >
              {({ getInputProps, getItemProps, highlightedIndex }) => (
                <div>
                  ...
                  {hasViews(actions) && (
                    <NavigatorSection
                      label={t('navigatorSectionHeaders.navigateTo', 'Navigate to')}
                  ...
                  {hasActions(actions) && (
                    <NavigatorSection
                      label={t('navigatorSectionHeaders.quickActions', 'Quick Actions')}
                      getItemProps={getItemProps}
                      highlightedIndex={highlightedIndex}
                  ...
                  {hasCustomers(actions) && (
                    <NavigatorSection
                      label={t('navigatorSectionHeaders.searchCustomers', 'Search in customers')}
                      getItemProps={getItemProps}
                      highlightedIndex={highlightedIndex}
                  ...
                  {hasCatalog(actions) && (
                    <NavigatorSection
                      label={t('navigatorSectionHeaders.searchCatalog', 'Search in catalog')}
                      getItemProps={getItemProps}
                      highlightedIndex={highlightedIndex}
