...
import IconButtonTableCell from '@dashboard/components/tables/IconButtonTableCell';
...
import { MenuListUrlOrdering, menuUrl } from '@dashboard/oldSrc/navigation/urls';
            ...
            () => (
              <TableRow>
                <TableCell colSpan={numberOfColumns}>
                  {t('dashboard.Ws4ba', 'No menus found')}
                </TableCell>
              </TableRow>
            )
          )}
