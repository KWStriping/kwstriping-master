    ...
    >
      <CardTitle
        ...
        title={
          <>
            {isPrivate
              ? t('dashboard.THnjq', 'Private Metadata')
              : t('dashboard.cI+Zh', 'Metadata')}
            <IconButton
