...
import type { ShippingMethodFragment } from '@core/api/graphql';
import ArrowDropdown from '@dashboard/oldSrc/icons/ArrowDropdown';
                ...
                <div className={styles.option ?? ''}>
                  <Typography variant="body1">
                    <>
                      ...
                      {t('dashboard.pLVVc', 'Exclude postal codes')}
                    </>
                  </Typography>
                ...
                <div className={styles.option ?? ''}>
                  <Typography variant="body1">
                    <>
                      ...
                      {t('dashboard.qsOwa', 'Include postal codes')}
                    </>
                  </Typography>
                  <Typography color="textSecondary" variant="caption">
                    <>
                ...
                <TableRow>
                  <TableCell colSpan={2}>
                    <Typography color="textSecondary">
                      <>
                        {t('dashboard.yjarj', 'This shipping rate has no postal codes assigned')}
                      </>
                    </Typography>
                  </TableCell>
                </TableRow>
