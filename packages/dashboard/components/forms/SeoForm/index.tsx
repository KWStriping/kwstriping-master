...
import { getFieldError, getProductErrorMessage } from '@dashboard/oldSrc/utils/errors';
...
const SeoForm: FC<SeoFormProps> = (props) => {
  ...
  const getSlugHelperMessage = () => {
    ...
    if (allowEmptySlug && !error) {
      return t(seoFieldMessage.id, seoFieldMessage.defaultMessage);
    }
      ...
      <CardTitle
        ...
        toolbar={
          <Button variant="tertiary" onClick={toggleExpansion} data-test-id="edit-seo">
            {t('dashboard.editWebsiteSEO', 'Edit website SEO')}
          </Button>
        }
      />
      <CardContent>
          ...
          <div className={styles.container ?? ''}>
            <TextField
              ...
              label={
                <div className={styles.labelContainer ?? ''}>
                  <div className={styles.label ?? ''}>{t('dashboard.oDlcd', 'Slug')}</div>
                  {!!slug?.length && (
                    <span>
                      <Trans
                        t={t}
              ...
              label={
                <div className={styles.labelContainer ?? ''}>
                  <div className={styles.label ?? ''}>
                    {t('dashboard.2Cewo', 'Search engine title')}
                  </div>
                  {!!title?.length && (
                    <span>
                      <Trans
            ...
            <TextField
              ...
              label={
                <div className={styles.labelContainer ?? ''}>
                  <div className={styles.label ?? ''}>
                    {t('dashboard.XTIq8', 'Search engine description')}
                  </div>
                  {!!description?.length && (
                    <span>
                      <Trans
