...
import type { AccountErrorFragment, OrderErrorFragment } from '@core/api/graphql';
  ...
  return (
    <>
      ...
      <div className={styles.root ?? ''}>
        <div>
          <TextField
            ...
            label={t('dashboard.YazHG', 'Company')}
            name="companyName"
            onChange={onChange}
      ...
      <TextField
        ...
        label={t('dashboard.52Em/', 'Address line 1')}
        name="streetAddress1"
        onChange={onChange}
      ...
      <TextField
        ...
        label={t('dashboard.QY0a2', 'Address line 2')}
        name="streetAddress2"
        onChange={onChange}
      ...
      <div className={styles.root ?? ''}>
        ...
        <div>
          <TextField
            ...
            label={t('dashboard.YGfnY', 'ZIP / Postal code')}
            name="postalCode"
            onChange={onChange}
      ...
      <div className={styles.root ?? ''}>
        {isFieldAllowed(PossibleFormFields.COUNTRY_AREA) && (
          <div>
            <SingleAutocompleteSelectField
              ...
              label={t('dashboard.countryArea', 'Country area')}
              name="countryArea"
              onChange={onChange}
        ...
        <div>
          <SingleAutocompleteSelectField
            ...
            label={t('dashboard.ONi+O', 'Country')}
            name="country"
