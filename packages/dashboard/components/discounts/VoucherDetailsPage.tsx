...
import type { DiscountErrorFragment, VoucherDetailsFragment } from '@core/api/graphql';
              ...
              <div>
                ...
                {data?.discountType?.toString() === 'SHIPPING' ? (
                  <CountryList
                    ...
                    disabled={disabled}
                    emptyText={t('dashboard.d/LWa', 'Voucher applies to all countries')}
                    title={
                      <>
                        {/* voucher country range */}

                        {t('dashboard.bnmEd', 'Countries')}
                        <Typography variant="caption">
                          {t('dashboard.lT6fm', 'Voucher is limited to these countries')}
                        </Typography>
                      </>
                    }
