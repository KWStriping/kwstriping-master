...
import NavigatorButton from '@core/ui/components/buttons/NavigatorButton';
import { useBacklink } from '@core/ui/components/Layout/Backlink';
import Logo from '@core/ui/components/Layout/Logo';
...
import SidebarDrawer from '@dashboard/components/layout/SidebarDrawer';
import Sidebar from '@dashboard/components/layout/Sidebar';
import { useActionBar } from '@dashboard/components/bars/ActionBar';
...
const Layout: FC<LayoutProps> = ({ children, fullSize = false }) => {
  ...
  const activeMenuItemId = menuStructure.find((menuItem) => isMenuActive(router.asPath, menuItem))
    ?.id;
