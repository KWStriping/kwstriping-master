...
import { ResponsiveTable } from '@core/ui/components/table/ResponsiveTable';
                    ...
                    <TableCell align="right">
                      {isReturnable && (
                        <TextField
                          ...
                          error={isValueError}
                          helperText={
                            isValueError && t('dashboard.mproperValue', 'Improper value')
                          }
                        />
                      )}
                    </TableCell>
