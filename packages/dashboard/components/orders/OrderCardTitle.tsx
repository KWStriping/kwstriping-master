...
import { CircleIndicator } from '@core/ui/components/CircleIndicator';
import { makeStyles } from '@core/ui/theme/styles';
import DefaultCardTitle from '@dashboard/components/core/CardTitle';
...
function useFulfillmentStatusMessage(
  ...
  switch (status) {
    ...
    //   return t('fulfillmentStatus.fulfilledFrom', 'Fulfilled from {warehouseName}', args);
    case 'unfulfilled':
      return t(
