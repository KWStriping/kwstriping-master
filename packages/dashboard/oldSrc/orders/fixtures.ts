...
import { warehouseForPickup, warehouseList } from '@dashboard/oldSrc/warehouses/fixtures';

import { transformOrderStatus, transformPaymentStatus } from '../misc';

export const countries: CountryWithCodeFragment[] = [
  { __typename: 'Country', code: 'AF', country: 'Afghanistan' },
  { __typename: 'Country', code: 'AX', country: 'Åland Islands' },
  { __typename: 'Country', code: 'AL', country: 'Albania' },
  { __typename: 'Country', code: 'DZ', country: 'Algeria' },
  { __typename: 'Country', code: 'AS', country: 'American Samoa' },
];
export const shop: OrderDetailsQuery['shop'] = {
  ...
  autoApproveFulfillment: true,
};

export const clients: RelayToFlat<NonNullable<SearchCustomersQuery['search']>> = [
  {
...
export const orders: RelayToFlat<NonNullable<OrderListQuery['orders']>> = [
  {
    __typename: 'Order',
    billingAddress: {
      __typename: 'Address',
  ...
  },
  {
    ...
    id: 'T3JkZXI6MTg=',
    number: '18',
    paymentStatus: ChargeStatus.NotCharged,
...
export const order = (placeholder: string): OrderDetailsFragment => ({
  __typename: 'Order',
  giftCards: [],
  actions: [OrderAction.Capture, OrderAction.MarkAsPaid, OrderAction.Refund, OrderAction.Void],
  shippingMethods: [
    {
  ...
  events: [
    {
      ...
      type: OrderEventType.FulfillmentFulfilledItems,
      app: {
        id: 'ZXCkcmVasdwoxTW==',
        __typename: 'App',
        name: 'Testapp',
    ...
    },
    {
      ...
      transactionReference: '123',
      type: OrderEventType.FulfillmentRefunded,
      app: {
        id: 'ZXCkcmVasdwoxTW==',
        __typename: 'App',
        name: 'Testapp',
    ...
    },
    {
      ...
      type: OrderEventType.ExternalServiceNotification,
      user: null,
      app: null,
    },
    {
      ...
      discount: null,
      email: null,
      emailType: OrderEventEmailType.OrderCancel,
      id: 'T3JkZXJFdmVudDo3',
      invoiceNumber: null,
      lines: [],
      message: null,
    ...
    },
    {
      ...
      discount: null,
      email: null,
      emailType: OrderEventEmailType.OrderRefund,
      id: 'T3JkZXJFdmVudDo4',
      invoiceNumber: null,
      lines: [],
      message: null,
    ...
    },
    {
      ...
      type: OrderEventType.PaymentAuthorized,
      user: null,
      app: null,
    },
  ],
  ...
  fulfillmentMethod: warehouseForPickup,
  shippingPrice: {
    __typename: 'TaxedMoney',
    gross: {
      __typename: 'Money',
...
export const flatOrders = orders.map((order) => ({
  ...
  orderStatus: transformOrderStatus(order.status, {
    t: (message: MessageDescriptor) => message.defaultMessage,
  } as unknown),
...
export const fulfillOrderLine = (placeholderImage: string): OrderFulfillmentLineFragment => ({
  __typename: 'OrderLine',
  id: 'T3JkZXJMaW5lOjIz',
  isShippingRequired: false,
  productName: 'Williams, Garcia and Walker (XS)',
...
export const orderSettings: OrderSettingsFragment = {
  ...
  autoConfirmAllNewOrders: true,
  autoFulfillNonShippableGiftCard: false,
};
