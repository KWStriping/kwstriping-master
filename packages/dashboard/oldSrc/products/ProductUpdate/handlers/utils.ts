import type { ProductUpdateSubmitData } from '@dashboard/components/products/ProductUpdatePage/types';
import { getColumnChannelAvailability } from '@dashboard/components/products/Products/columnData';
import type {
  FileUploadMutation,
...
import { prepareAttributesInput } from '@dashboard/oldSrc/attributes/utils/handlers';
import { VALUES_PAGINATE_BY } from '@dashboard/oldSrc/config';
import { getAttributeInputFromProduct } from '@dashboard/oldSrc/products/utils/data';
