...
import type { ProductListFilterOpts } from '@dashboard/components/products/ProductListPage';
import { StockAvailability } from '@core/api/graphql';
import { attributes } from '@dashboard/oldSrc/attributes/fixtures';
import { categories } from '@dashboard/oldSrc/categories/fixtures';
import { collections } from '@dashboard/oldSrc/collections/fixtures';
import { fetchMoreProps, searchPageProps } from '@dashboard/oldSrc/fixtures';
import { productKlasses } from '@dashboard/oldSrc/productKlasses/fixtures';
