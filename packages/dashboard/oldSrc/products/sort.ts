import { ProductOrdering } from '@core/api/constants';
import type { ProductOrder } from '@core/api/graphql';
import type { ProductListUrlQueryParams } from '@dashboard/oldSrc/products/urls';
import { ProductListUrlOrdering } from '@dashboard/oldSrc/products/urls';
import { getOrderingDirection } from '@dashboard/oldSrc/utils/sort';
