import type { ProductKlass } from '@core/auth/dist/apollo/types';
...
import { AttributeInputType, ProductMediaType } from '@core/api/graphql';
import { WeightUnit } from '@core/api/constants';
import { channelsList } from '@dashboard/oldSrc/channels/fixtures';
