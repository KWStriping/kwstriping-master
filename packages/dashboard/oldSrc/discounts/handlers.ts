...
import { DiscountErrorCode, SaleType, VoucherType } from '@core/api/constants';
import type { ChangeEvent, FormChange, SubmitPromise } from '@dashboard/hooks/useForm';
import type { ChannelVoucherData } from '@dashboard/oldSrc/channels/utils';
import { validateSalePrice, validateVoucherPrice } from '@dashboard/oldSrc/channels/utils';
