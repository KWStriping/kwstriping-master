export const giftCardsListHeaderMenuItemsMessages = {
  settings: {
    id: 'F69lwk',
  ...
  noGiftCardsProductsAndProductKlasses: {
    id: 'U9o2bV',
    defaultMessage:
      '{{createGiftCardProductKlass}} and {{giftCardProduct}} to start selling gift cards in your store.',
    description: 'no gift card products and types alert message',
  },
  noGiftCardsProductKlasses: {
    id: 'VI+X8H',
    defaultMessage: '{{createGiftCardProductKlass}} to start selling gift cards in your store.',
...
export const giftCardsListTableMessages = {
...
export const updateGiftCardFormMessages = {
