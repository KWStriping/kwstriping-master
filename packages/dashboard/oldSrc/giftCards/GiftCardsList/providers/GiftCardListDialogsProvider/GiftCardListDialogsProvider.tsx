import GiftCardListPageDeleteDialog from '@dashboard/components/giftCards/GiftCardDeleteDialog/GiftCardListPageDeleteDialog';
import GiftCardBulkCreateDialog from '@dashboard/oldSrc/giftCards/GiftCardBulkCreateDialog';
import GiftCardCreateDialogContent from '@dashboard/oldSrc/giftCards/GiftCardCreateDialog';
import GiftCardExportDialogContent from '@dashboard/oldSrc/giftCards/GiftCardExportDialogContent';
