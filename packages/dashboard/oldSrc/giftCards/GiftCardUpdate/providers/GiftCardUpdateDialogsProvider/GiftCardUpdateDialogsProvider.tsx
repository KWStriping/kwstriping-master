import GiftCardUpdatePageDeleteDialog from '@dashboard/components/giftCards/GiftCardDeleteDialog/GiftCardUpdatePageDeleteDialog';
import { giftCardsListPath, giftCardUrl } from '@dashboard/oldSrc/giftCards/urls';
