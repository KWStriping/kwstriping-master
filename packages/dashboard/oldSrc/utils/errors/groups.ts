  ...
  if (err) {
    switch (err.code) {
      case GroupErrorCode.AssignNonStaffMember:
        return t('dashboard.assignNonStaffMember', messages.assignNonStaffMember.defaultMessage);
      ...
      case GroupErrorCode.OutOfScopePermission:
        return t('dashboard.permissionOutOfScope', messages.permissionOutOfScope.defaultMessage);
      case GroupErrorCode.CannotRemoveFromLastGroup:
        return t(
          'dashboard.cannotRemoveFromLastGroup',
