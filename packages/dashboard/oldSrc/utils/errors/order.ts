  ...
  if (err) {
    switch (err.code) {
      case OrderErrorCode.BillingAddressNotSet:
        return t('dashboard.illingNotSet', messages.billingNotSet.defaultMessage);
      case OrderErrorCode.CannotCancelFulfillment:
        return t(
          'dashboard.cannotCancelFulfillment',
          messages.cannotCancelFulfillment.defaultMessage
        );
      case OrderErrorCode.CannotCancelOrder:
        return t('dashboard.cannotCancelOrder', messages.cannotCancelOrder.defaultMessage);
      case OrderErrorCode.CannotRefund:
        return t('dashboard.cannotRefund', messages.cannotRefund.defaultMessage);
      case OrderErrorCode.CaptureInactivePayment:
        return t('dashboard.captureInactive', messages.captureInactive.defaultMessage);
      case OrderErrorCode.FulfillOrderLine:
        return t('dashboard.cannotFulfillLine', messages.cannotFulfillLine.defaultMessage);
      case OrderErrorCode.InsufficientStock:
        return t('dashboard.insufficientStock', messages.insufficientStock.defaultMessage);
      case OrderErrorCode.NotEditable:
        return t('dashboard.otEditable', messages.notEditable.defaultMessage);
      case OrderErrorCode.OrderNoShippingAddress:
        return t('dashboard.oShippingAddress', messages.noShippingAddress.defaultMessage);
      case OrderErrorCode.PaymentMissing:
        return t('dashboard.paymentMissing', messages.paymentMissing.defaultMessage);
      case OrderErrorCode.ShippingMethodNotApplicable:
        return t(
          'dashboard.shippingNotApplicable',
          messages.shippingNotApplicable.defaultMessage
        );
      case OrderErrorCode.ShippingMethodRequired:
        return t('dashboard.shippingRequired', messages.shippingRequired.defaultMessage);
      case OrderErrorCode.VoidInactivePayment:
        return t('dashboard.cannotVoid', messages.cannotVoid.defaultMessage);
    }
  }
