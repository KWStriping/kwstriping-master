import type { FilterElementGeneric } from '@dashboard/components/core/Filter';
...
import type { FetchMoreProps, KeyValue, MinMax, SearchPageProps } from '@dashboard/oldSrc/types';
