export const messages = {
  ...
  variantNotChosen: {
    ...
    defaultMessage: 'Please choose one of these options',
  },
  addedToCart: {
    id: 'app.product.addedToCart',
    description: 'Message displayed after adding product to the cart.',
  ...
  shippingAddressCardHeader: {
    ...
    defaultMessage: 'Job site address',
  },
